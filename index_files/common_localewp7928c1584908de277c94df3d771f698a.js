...
(window.locales = window.locales || {}).common_locale = {
  ...
  enableTtsAutoplay: function(d) { return "Enable Automatic Instruction Playback (Only certain courses and web browsers)"; },
  ...
  explainTtsAutoplay: function(d) { return "For Chrome, Internet Explorer, and Edge browsers only: When Automatic Instruction Playback is on, the instructions will be automatically read when a student opens a level. This makes it easier for students who are not yet fluent readers to complete the lessons."; },
  ...
  sectionsNotificationAlreadyOwned: function(d) { return "You are already the owner of section " + d.sectionId + "."; },
  ...
  virtualHocBannerBody1: function(d) { return "Teaching in a remote classroom?"; },
  virtualHocBannerBody2: function(d) { return "See our guide for hosting a virtual Hour of Code."; },
  virtualHocBannerLinkText: function(d) { return "Get started"; },
